...
public class StripNails extends Fastener
{
	 ...
	 * @throws SQLException
	 */
	public StripNails(int id) throws ClassNotFoundException, SQLException
	{
		this.id = id;
	 ...
	 * @throws SQLException
	 */
	public StripNails(int id, String upc, int manufacturerID, int price, String description,
